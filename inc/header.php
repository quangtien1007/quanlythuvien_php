				...
				<div class="sidebar-menu">
					...
					<ul>
						...
						<li class="menu <?php if ($page == 'sinfo') {
							...
							<a href="all-student-info.php"><i class="fas fa-desktop"></i>Thông tin sinh viên</a>
						</li>
						<li class="menu <?php if ($page == 'tinfo') {
											echo 'active';
										} ?>">
							<a href="all-teacher-info.php"><i class="fas fa-desktop"></i>Thông tin giáo viên</a>
						</li>
						...
						<li class="menu menu-toggle1">
							...
							<ul class="menus1">
								<li><a href="student-issue-book.php">sách cho học sinh</a></li>
								<li><a href="teacher-issue-book.php">sách cho giáo viên</a></li>
							</ul>
						</li>
						<li class="menu menu-toggle3">
							<a href="#"><i class="fas fa-users"></i>quản lý người dùng <span class="fa fa-chevron-down"></span></a>
							<ul class="menus3">
								<li><a href="add-student.php">thêm học sinh</a></li>
						...
						<li class="menu <?php if ($page == 'ibook') {
							...
							<a href="issued-books.php"><i class="fas fa-bookmark"></i>sách đã phát hành</a>
						</li>
						<li class="menu <?php if ($page == 'rbook') {
											echo 'active';
										} ?>">
							<a href="requested-books.php"><i class="fas fa-book"></i>đề nghị đặt sách</a>
						</li>
						<li class="menu menu-toggle4">
							<a href="#"><i class="far fa-share-square"></i>gửi thông báo cho người dùng <span class="fa fa-chevron-down"></span></a>
							<ul class="menus4">
								<li><a href="send-to-student.php">gửi đến học sinh</a></li>
								<li><a href="send-to-teacher.php">gửi đến giáo viên</a></li>
							</ul>
						</li>
					</ul>
				</div>
