            ...
            <div class="st-issuedBook">
                ...
                <form action="" method="post" class="issue-content">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            <td>
                                <input type="text" class="form-control bdr" name="bname" value="" placeholder="Tên sách yêu cầu thuê">
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <input type="text" class="form-control bdr" name="burl" value="" placeholder="URL sách">
                            </td>
                        </tr>
                    </table>
                    <input type="submit" name="submit" value="Gửi yêu cầu" class="btn">
                </form>
