            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="right text-right">
                        ...
                        <span class="disabled">thông tin</span>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-9">
                        <div class="details">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group details-control">
                                    <label for="sem" class="text-right">Học kỳ:</label>
                                    <input type="text" class="form-control custom" name="sem" value="<?php echo $sem; ?>" />
                                </div>
                                <div class="form-group details-control">
                                    <label for="session" class="text-right">Niên học:</label>
                                ...
                                <div class="form-group details-control">
                                    <label for="phone">Số điện thại:</label>
